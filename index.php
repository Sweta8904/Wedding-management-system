          ...
          <div class="work-box">
            <a href="img/img1.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title"> Rohan & Priya</h2>
                    <div class="w-more">
                      <span class="w-ctegory"> The Smith Family</span> / <span class="w-date"> June 12, 2023</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
          ...
          <div class="work-box">
            <a href="img/img2.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title"> Aryan & Kiara </h2>
                    <div class="w-more">
                      <span class="w-ctegory">The Patel Family </span> / <span class="w-date">August 25, 2022</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
          ...
          <div class="work-box">
            <a href="img/img3.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title"> Vikram & Sophia</h2>
                    <div class="w-more">
                      <span class="w-ctegory">The Kumar Family </span> / <span class="w-date"> October 15, 2023</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
          ...
          <div class="work-box">
            <a href="img/img4.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title"> Rahul & Emily </h2>
                    <div class="w-more">
                      <span class="w-ctegory">The Gupta Family </span> / <span class="w-date"> April 22, 2023</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
          ...
          <div class="work-box">
            <a href="img/img5.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                 <div class="col-sm-8">
                    <h2 class="w-title">Siddharth & Aaradhya</h2>
                    <div class="w-more">
                      <span class="w-ctegory">The Jain Family</span> / <span class="w-date">February 14, 2023</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
          ...
          <div class="work-box">
            <a href="img/img6.jpg" data-lightbox="gallery-mf">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    <h2 class="w-title">Sachin & Ankita </h2>
                    <div class="w-more">
                      <span class="w-ctegory">- The Sharma Family</span> / <span class="w-date">September 10, 2023</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                     I'm thrilled to be your partner in planning the wedding of your dreams! With a passion for creating unforgettable experiences and a keen eye for detail, I've helped countless couples navigate the wedding planning process with ease and joy. Whether you're a classic romance or a modern trendsetter, I'll work closely with you to craft a bespoke wedding celebration that reflects your unique style and love story.
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico">
                      ...
                      <li><span class="ion-ios-telephone"></span> +918904546831</li>
                      <li><span class="ion-email"></span>sweta890@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
  ...
  <a href="https://www.facebook.com" target="_blank">
    <span class="ico-circle">
      <i class="ion-social-facebook"></i>
                                           ...
                                           <li><a href="https://www.instagram.com" target="_blank"><span class="ico-circle"><i class="ion-social-instagram"></i></span></a></li>
                      <li><a href="https://www.twitter.com" target="_blank"><span class="ico-circle"><i class="ion-social-twitter"></i></span></a></li>
                      <li><a href="https://www.pinterest.com" target="_blank"><span class="ico-circle"><i class="ion-social-pinterest"></i></span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
