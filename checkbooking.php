            ...
            <div id="contact" class="box-shadow-full">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="socials">
                    <ul>
                      <li><a href="facebook.com"><span class="ico-circle"><i class="ion-social-facebook"></i></span></a></li>
                      <li><a href="instagram.com"><span class="ico-circle"><i class="ion-social-instagram"></i></span></a></li>
                      <li><a href="twitter.com"><span class="ico-circle"><i class="ion-social-twitter"></i></span></a></li>
                      <li><a href="pinterest.com"><span class="ico-circle"><i class="ion-social-pinterest"></i></span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
